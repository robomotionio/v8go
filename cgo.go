...
// #cgo windows,amd64 LDFLAGS: -L${SRCDIR}/deps/windows_x86_64 -llibv8 -ldbghelp -lwinmm -lshlwapi -ladvapi32
// #cgo windows,arm64 LDFLAGS: -L${SRCDIR}/deps/windows_arm64 -llibv8 -ldbghelp -lwinmm -lshlwapi -ladvapi32
import "C"
