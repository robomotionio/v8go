...
// #cgo darwin CXXFLAGS: -stdlib=libc++ -I${SRCDIR}/deps/include_libcxx -I${SRCDIR}/deps/include_libcxxabi -D_LIBCPP_HARDENING_MODE=_LIBCPP_HARDENING_MODE_EXTENSIVE -D_LIBCPP_DISABLE_VISIBILITY_ANNOTATIONS -D_LIBCXXABI_DISABLE_VISIBILITY_ANNOTATIONS -include ctype.h
